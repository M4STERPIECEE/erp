          ...
          <ModalBody px={7} pb={4} bg="white">
            <Grid templateColumns={{ base: "1fr", md: "1fr 1fr" }} gap={4}>
              <FormControl isRequired isInvalid={!!errors.type} gridColumn={{ md: "span 2" }}>
                ...
                <SelectWrapper isInvalid={!!errors.type}>
                  <Select {...customSelect} {...register("type", { required: "Le type est obligatoire" })}>
              ...
              <FormControl isRequired isInvalid={!!errors.dateDebut}>
                ...
                <Input type="date" {...customInput} {...(errors.dateDebut ? errorInput : {})}
              ...
              <FormControl isRequired isInvalid={!!errors.dateFin}>
                ...
                <Input type="date" {...customInput} {...(errors.dateFin ? errorInput : {})}
                  {...register("dateFin", {
              ...
              {joursOuvrables > 0 && (
                <Box gridColumn={{ md: "span 2" }}>
                  <Flex align="center" gap={2} bg="blue.50" p={3} rounded="lg">
                    <Box as="span" className="material-symbols-outlined" fontSize="18px" color="blue.500">info</Box>
